...
@Database( //((Raikwar, 2023),(AndroidDevelopers, 2024))
    entities = [
        User::class,
        UserSettings::class,
        Transaction::class,
...
// Main Room database class that holds all DAOs and entities used in the app
abstract class AppDatabase : RoomDatabase() { //((Raikwar, 2023),(AndroidDevelopers, 2024))
