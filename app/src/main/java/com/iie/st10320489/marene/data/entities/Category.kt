...
// Room entity representing a user's category (e.g., Food, Travel)
@Entity(tableName = "Category")// ((Viegen, 2022), (androidbyexample, 2024))
data class Category(
    @PrimaryKey(autoGenerate = true) val categoryId: Int = 0, // Auto-generated unique ID for the category
    val userId: Int,
    val name: String,
    val icon: Int,
    val colour: Int
)// (androidbyexample, 2024)
