...
// Represents the Category table used to organize transactions by type (e.g., Food, Transport)
@Entity(tableName = "Category")//(Viegen, 2022), (androidbyexample, 2024)
data class Category(
    @PrimaryKey(autoGenerate = true) val categoryId: Int = 0, // Auto-generated unique ID for each category
    val userId: Int,
    val name: String,
    val icon: Int,
    val colour: Int
