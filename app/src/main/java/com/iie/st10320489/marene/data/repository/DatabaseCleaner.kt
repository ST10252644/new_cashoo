...
// Utility class to clear all data from the database tables
class DatabaseCleaner( ////(Raikwar, 2024), (Raikwar, 2023)
    ...
    // Suspended function that deletes all records from each table using their respective DAOs
    suspend fun clearAllData() {  ////(Raikwar, 2024), (Raikwar, 2023)
