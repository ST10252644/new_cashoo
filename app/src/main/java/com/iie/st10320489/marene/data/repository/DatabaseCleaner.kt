...
class DatabaseCleaner( //((AndroidDevelopers, 2024), (AndroidDevelopers, 2024), (Raikwar, 2024), (Raikwar, 2023), (Cal, 2023),(Cal, 2023), (College, 2025),)
    ...
    // Suspended function to clear all data from all relevant tables asynchronously on IO thread
    suspend fun clearAllData() { //((Raikwar, 2023),(AndroidDevelopers, 2024))
        withContext(Dispatchers.IO) {//((Cal, 2023), (College, 2025))
