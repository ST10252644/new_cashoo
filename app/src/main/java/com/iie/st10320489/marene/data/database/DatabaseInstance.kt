...
object DatabaseInstance {
    ...
    @Volatile
    private var INSTANCE: AppDatabase? = null  // (AndroidDevelopers, 2024), (AndroidDevelopers, 2024), (Raikwar, 2024), (Raikwar, 2023), (Cal, 2023)
    ...
    fun getDatabase(context: Context): AppDatabase {
        return INSTANCE ?: synchronized(this) {
            val instance = Room.databaseBuilder(
                ...
                .build()
            INSTANCE = instance
            instance   //((Raikwar, 2024), (Raikwar, 2023),(Cal, 2023), (College, 2025))
        }
    }
}
