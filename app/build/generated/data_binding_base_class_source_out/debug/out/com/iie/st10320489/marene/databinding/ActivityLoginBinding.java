...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView deleteTables;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout container, @NonNull TextView deleteTables,
      @NonNull EditText emailEditText, @NonNull TextView forgotPassword,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.deleteTables;
      TextView deleteTables = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, container, deleteTables,
          emailEditText, forgotPassword, loginButton, passwordEditText, registerNowText, textView2,
